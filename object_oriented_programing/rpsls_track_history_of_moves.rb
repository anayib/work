...
Initialize the moves_history stay in the Player Class
Initialize an array to track each Player moves_history
Create am array  state in Player Class to keep track of all the moves.

Update moves_history
********************
Each time we call the instance method Human#choose or Computer#choose we call moves_history << move.value
to update the values in the moves_history array-

Display history of moves
************************
Define the RGame#display_history_of_moves  istance method
call the display_history_of_moves frrom the RGame play method
=end
